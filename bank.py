...
if __name__ == '__main__':
    cust1 = BankAccount(name='LIMON', mobile_no=20193290714, initial_depo=1000, pin=123)
    cust2 = BankAccount(name='NIROB', mobile_no=20193290618, initial_depo=200000, pin=456)
